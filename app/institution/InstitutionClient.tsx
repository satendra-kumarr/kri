...
const leadershipTeam: Leader[] = [
    ...
    },
    {
        ...
        description: [
            <>
                <strong>Mr. Ibrahim</strong> is a B.E. (Computer Science) graduate with over 9+ years of professional experience in the engineering department in Madurai.
                With a strong technical background and practical industry exposure, he brings valuable insights into institutional branding and student engagement.
                He currently serves as the <strong>Brand Ambassador</strong> and Promoter for KRI College, where he actively manages <strong>college promotions</strong>, advertising campaigns, and outreach activities.
                In addition to promotional responsibilities, he plays an important role in coordinating and supporting <strong>student safety initiatives</strong>, contributing to a secure, trustworthy, and student-friendly academic environment.
            </>
        ]
    ...
    {
        id: 'Manager',
        name: 'Mr. Shahul Ameed',
        qualification: '(B.Com. & M.Com.)',
        role: 'Financial Manager',
        role2: 'King Rashid Internatonal College (KRI College)',
        image: '/images/Shahul.jpeg',
        description: [
            <>
                Mr. Shahul Ameed is a B.Com. and M.Com. degree holder with over
                <strong> 6 years experience</strong> in the Accounts and Finance department
                across Tamil Nadu.

                He currently serves as <strong>Financial Manager</strong> at KRI College,
                where he handles financial planning, budgeting, and profit and loss accounts.

                He is actively involved in <strong>fee structuring</strong>, scholarship facilitation,
                and coordination of government approvals.

                His <strong>financial expertise</strong> contributes to institutional stability
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="pt-4 border-t border-gray-100">
                                            ...
                                            <div className="mt-4">
                                                <Link href="/contact" className="px-4 py-2 bg-[#D4AF37] text-white text-xs font-bold uppercase rounded-sm hover:bg-[#b5952f]">Register for Exam</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
